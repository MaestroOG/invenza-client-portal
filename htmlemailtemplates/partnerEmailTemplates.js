...
<head>
  ...
  <style>
    ...
    @media (prefers-color-scheme: dark) {
      ...
      .btn    { background:#F9FE02 !important; color:#000000 !important; }
...
<body class="bg" style="margin:0;padding:0;background:#f4f6fa;">
  ...
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
    Your partnership with Invenza has ended. Here’s what happens next.
  </div>
    ...
    <tr>
      <td align="center" style="padding:0 16px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:640px;background:#ffffff;border-radius:12px;overflow:hidden;" class="card">
          ...
          <!-- Brand Header -->
          <tr>
            <td style="background:#F9FE02;padding:22px 28px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left">
                    <span style="font-family:Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;color:#000000;font-weight:700;letter-spacing:.3px;">
                      Invenza
                    </span>
                  </td>
                  <td align="right">
                    <span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:20px;color:#8E8E8E;opacity:.95;">
                      Partnership Update
                    </span>
                  </td>
                </tr>
          ...
          <tr>
            <td class="px" style="padding:0 28px 8px 28px;">
              <p class="text" style="margin:0 0 10px 0;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;color:#1f2937;">
                We’re writing to let you know that your partnership with <strong>Invenza</strong> for <strong>${companyName}</strong> has been formally ended as of <strong>${endDate}</strong>.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td class="px" style="padding:16px 28px 28px 28px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0;">
                <tr>
                  <td align="left" style="border-radius:8px;" bgcolor="#F9FE02">
                    <a
                      href="${supportEmail}"
                      target="_blank"
                      class="btn"
                      style="font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:20px;text-decoration:none;padding:12px 18px;display:inline-block;border-radius:8px;background:#F9FE02;color:#000000;font-weight:700;"
                    >
                      Contact Support
                    </a>
                  </td>
