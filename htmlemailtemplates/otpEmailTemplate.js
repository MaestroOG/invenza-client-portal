...
<body class="bg" style="margin:0;padding:0;background:#f4f6fa;">
  ...
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
    Your Invenza verification code is ${otp}. It expires in 10 minutes.
  </div>
    ...
    <tr>
      <td align="center" style="padding:0 16px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:640px;background:#ffffff;border-radius:12px;overflow:hidden;" class="card">
          ...
          <!-- Header bar -->
          <tr>
            <td style="background:#F9FE02;padding:18px 24px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.2;color:#000000;font-weight:700;">
                    Invenza
                  </td>
                  <td align="right" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#8E8E8E;">
                    Secure Verification
                  </td>
                </tr>
              </table>
