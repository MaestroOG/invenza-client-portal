                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td style="text-align:right;vertical-align:middle;">
                      <!-- small badge -->
                      <span style="display:inline-block;background:#F9FE02;color:#000;font-size:12px;padding:6px 10px;border-radius:999px;font-weight:600;">Admin Alert</span>
                    </td>
                  </tr>
                </table>
              </td>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td style="padding-top:18px;text-align:center;">
                      <a href="https://your-app.example.com/admin/projects" target="_blank" style="display:inline-block;padding:12px 20px;border-radius:10px;background:#F9FE02;color:#000000;text-decoration:none;font-weight:600;font-size:14px;">Open Admin Dashboard</a>
                    </td>
                  </tr>
            ...
            <tr>
              <td style="padding:16px 28px 24px 28px;background:#fbfdff;border-top:1px solid #eef2ff;">
                <table role="presentation" width="100%">
                  <tr>
                    <td style="font-size:13px;color:#94a3b8;">Sent by <strong>Admin Team at Invenza</strong></td>
                    <td style="text-align:right;font-size:13px;color:#94a3b8;">Need help? <a href="mailto:support@Invenza.com" style="color:#2563eb;text-decoration:none;">support@Invenza.com</a></td>
                  </tr>
                </table>
              </td>
            </tr>
