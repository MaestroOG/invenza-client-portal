    ...
    return (
        <>
            <form action={formAction} className="grid gap-2">
                <Input type="email" className={'max-w-2xl placeholder:text-muted'} name='email' value={email} />
                <Input type={'email'} className={'max-w-2xl placeholder:text-muted'} name='newEmail' placeholder="Enter new email" />
