                    ...
                    <form action={formAction}>
                        ...
                        <div className="grid gap-4 mt-5">
                            <div className="grid gap-3">
                                <Label className={'text-foreground'} htmlFor='title'>Task Title</Label>
                                <Input className={'text-foreground'} type={'text'} name='title' defaultValue={task?.title} />
                            </div>
                            <div className="grid gap-3">
                            ...
                            <div className="flex flex-col gap-3">
                                <Label htmlFor="dueDate" className="px-1 text-foreground">
                                    Schedule Task
                                </Label>
                            ...
                            <div className="grid gap-3">
                                <Label className={'text-foreground'} htmlFor='status'>Task Status</Label>
