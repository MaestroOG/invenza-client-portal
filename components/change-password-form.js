    ...
    return (
        <>
            <form action={formAction} className="grid gap-2">
                <Input type="password" className={'max-w-2xl placeholder:text-muted'} name='oldPassword' placeholder="Enter old password" />
                <Input type={'password'} className={'max-w-2xl placeholder:text-muted'} name='newPassword' placeholder="Enter new password" />
