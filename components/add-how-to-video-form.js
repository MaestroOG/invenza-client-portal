        ...
        <>
            <form action={formAction} className="mt-4 grid gap-4 max-w-2xl">
                <div className="grid gap-2">
                    <Label className={'text-background'} htmlFor="title">Title <span className="text-red">*</span></Label>
                    <Input className={'text-background'} type={'text'} name='title' />
                </div>
                <div className="grid gap-2">
                    <Label className={'text-background'} htmlFor="title">Video Embed URL <span className="text-red">*</span></Label>
                    <Input className={'text-background'} type={'url'} name='videoLink' />
                </div>
