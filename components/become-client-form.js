...
import { createClientUser } from "@/action/user";
        ...
        <>
            <form action={formAction} className={cn("flex flex-col gap-6", className)} {...props}>
                <div className="flex flex-col items-center gap-2 text-center">
                    <h1 className="text-2xl font-bold text-background">Become A Client</h1>
                    <p className="text-muted-background text-sm text-balance">
                        Enter your information below to become a client
                    </p>
                </div>
